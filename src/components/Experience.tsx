...
const jobs: Job[] = [
  {
    ...
    note: 'An independent contract engagement routed through Incube Innovation Incubator LLP. Travel360 is an early-stage startup building "the world\'s first atomic travel marketplace" — currently pre-launch (public site is a waitlist landing page).',
    bullets: [
      "Engaged at pre-launch to help build the first-phase MVP of an early-stage travel marketplace.",
      "Working on the backend with Node.js and Hono.js — a lightweight, TypeScript-first web framework — and the client with React.",
      "Added Node.js and TypeScript alongside an existing Java/Spring Boot + Flutter skill set — the Node/TypeScript stack suits the startup's faster-iteration MVP phase.",
      "Early-stage ownership — involved in MVP shape and core feature work rather than narrow ticket-level tasks.",
    ],
  },
  {
    title: "Junior Full Stack Developer",
    ...
    note: "Promoted to Junior Full Stack Developer in August 2025 after a 1-year trainee program. Primary employer — now working across product delivery and an independent client contract (Travel360).",
    bullets: [
      ...
      "Currently building a WhatsApp Business API integration and a companion mobile application as part of ongoing product work at Incube.",
    ],
  },
];
